...
export const places: Place[] = [
  ...
  P({
    ...
    viewsCount: 35200,
    trending: true,
    mapsUrl: "https://www.google.com/maps/search/?api=1&query=Historic+Al+Balad+Nasseef+House+Jeddah",
    image: "https://images.unsplash.com/photo-1578895210405-907db48a7111?auto=format&fit=crop&w=800&q=80",
  }),

  // ==================== أسواق ومولات التسوق الحقيقية في جدة ====================
  P({
    id: "sh1",
    nameAr: "رد سي مول (طريق الملك عبد العزيز)",
    nameEn: "Red Sea Mall (King Abdulaziz Road)",
    kind: "shopping",
    categoryAr: "تسوق ومولات",
    subCategoryAr: "مولات ومراكز تجارية",
    subCategoryEn: "Mega Shopping Mall & Cinema",
    districtId: "zahra",
    moods: ["shopping", "games"],
    pricePerPerson: 0,
    durationMin: 120,
    indoor: true,
    groups: ["family", "friends", "couple", "kids", "tourist"],
    kidsFriendly: true,
    reservation: false,
    verified: true,
    accessible: true,
    opensAt: 10,
    closesAt: 25,
    descAr: "أكبر وأشهر مول تجاري وترفيهي في جدة برصيد مئات الماركات العالمية، سينما فوكس، ساحة مطاعم ضخمة ومناطق ترفيه أطفال.",
    descEn: "Jeddah's premier mega mall featuring global fashion brands, VOX cinemas & family entertainment.",
    whyAr: "الوجهة المتكاملة الأولى للتسوق والتسلية والعشاء بجدة.",
    parkingAr: "مواقف متعددة الأدوار واسعة ومجانية",
    rating: 4.9,
    viewsCount: 38400,
    trending: true,
    mapsUrl: "https://www.google.com/maps/search/?api=1&query=Red+Sea+Mall+King+Road+Jeddah",
    image: "https://images.unsplash.com/photo-1567449303078-57ad995bd301?auto=format&fit=crop&w=800&q=80",
  }),
  P({
    id: "sh2",
    nameAr: "مول العرب (حي النزهة / طريق المطار)",
    nameEn: "Mall of Arabia (Al Nuzhah / Airport Road)",
    kind: "shopping",
    categoryAr: "تسوق ومولات",
    subCategoryAr: "مولات ومراكز تجارية",
    subCategoryEn: "Family Mall & KidZania",
    districtId: "airport",
    moods: ["shopping", "calm"],
    pricePerPerson: 0,
    durationMin: 120,
    indoor: true,
    groups: ["family", "friends", "kids", "tourist"],
    kidsFriendly: true,
    reservation: false,
    verified: true,
    accessible: true,
    opensAt: 10,
    closesAt: 25,
    descAr: "مول تجاري ضخم قرب المطار يضم صالة ألعاب كيدزانيا الشهيرة للأطفال، محلات أزياء عائلية ومطاعم متنوعة.",
    descEn: "Family shopping destination near airport with KidZania, major department stores & dining.",
    whyAr: "ممتاز جداً لطلعات العائلات والتسوق المتكامل للأطفال والشباب.",
    parkingAr: "مواقف واسعة مكشوفة ومغطاة",
    rating: 4.8,
    viewsCount: 31000,
    trending: true,
    mapsUrl: "https://www.google.com/maps/search/?api=1&query=Mall+of+Arabia+Jeddah",
    image: "https://images.unsplash.com/photo-1519567241046-7f570eee3ce6?auto=format&fit=crop&w=800&q=80",
  }),
  P({
    id: "sh3",
    nameAr: "مركز ستارز أفينيو الفاخر (طريق الملك)",
    nameEn: "Stars Avenue Luxury Mall (King Road)",
    kind: "shopping",
    categoryAr: "تسوق ومولات",
    subCategoryAr: "أزياء وماركات فاخرة",
    subCategoryEn: "High-End Luxury Boutique Mall",
    districtId: "zahra",
    moods: ["shopping", "calm"],
    pricePerPerson: 0,
    durationMin: 90,
    ...
    opensAt: 10,
    closesAt: 24,
    descAr: "مركز التسوق الراقي والهدوء الفاخر، يضم أشهر بوتيكات الأزياء والمجوهرات العالمية ومقاهي هادئة.",
    descEn: "High-end luxury shopping mall home to world-renowned fashion houses & quiet cafes.",
    whyAr: "أفضل مركز للتسوق الفاخر والراقي بعيداً عن الزحام.",
    parkingAr: "خدمة صف السيارات ومواقف مغطاة VIP",
    rating: 4.8,
    viewsCount: 22100,
    trending: true,
    mapsUrl: "https://www.google.com/maps/search/?api=1&query=Stars+Avenue+Mall+Jeddah",
    image: "https://images.unsplash.com/photo-1441986300917-64674bd600d8?auto=format&fit=crop&w=800&q=80",
  }),
  P({
    id: "sh4",
    nameAr: "لو بريستيج مول المفتوح (طريق الملك)",
    nameEn: "Le Prestige Outdoor Mall (King Road)",
    kind: "shopping",
    categoryAr: "تسوق ومولات",
    subCategoryAr: "مولات ومراكز تجارية",
    subCategoryEn: "Open-Air Parisian Style Mall",
    districtId: "zahra",
    moods: ["shopping", "coffee", "calm"],
    pricePerPerson: 0,
    durationMin: 75,
    indoor: false,
    groups: ["couple", "friends", "family", "tourist"],
    kidsFriendly: true,
    reservation: false,
    verified: true,
    accessible: true,
    opensAt: 8,
    closesAt: 25,
    descAr: "مول مفتوح بتصميم باريسي فاخر ونوافير مائية، يضم أشهر كافيهات ومطاعم الماركات الأوروبية بجلسات خارجية ساحرة.",
    descEn: "Parisian-inspired open-air luxury lifestyle center with European outdoor dining.",
    whyAr: "جلسات راقية وأجواء تمشية تسوق أوروبية بقلب جدة.",
    parkingAr: "خدمة صف السيارات ومواقف المجمع",
    rating: 4.9,
    viewsCount: 26700,
    trending: true,
    mapsUrl: "https://www.google.com/maps/search/?api=1&query=Le+Prestige+Mall+Jeddah",
    image: "https://images.unsplash.com/photo-1555529669-e69e7aa0ba9a?auto=format&fit=crop&w=800&q=80",
  }),
  P({
    id: "sh5",
    nameAr: "سوق العلوي وسوق الندى التراثي (جدة التاريخية / البلد)",
    nameEn: "Souq Al Alawi & Al Nada (Historic Balad)",
    kind: "shopping",
    categoryAr: "تسوق ومولات",
    subCategoryAr: "أسواق شعبية وتراثية",
    subCategoryEn: "Traditional Heritage Souqs",
    districtId: "balad",
    moods: ["shopping", "culture"],
    pricePerPerson: 0,
    durationMin: 120,
    indoor: false,
    groups: ["family", "friends", "tourist", "solo"],
    ...
    opensAt: 9,
    closesAt: 23,
    descAr: "أقدم وأعرق الأسواق الشعبية في قلب جدة التاريخية لشراء العود الحجازي البخور التوابل والملابس التراثية والفضيات.",
    descEn: "Jeddah's oldest traditional bazaars for authentic spices, perfumes, oud & Hejazi crafts.",
    whyAr: "تجربة تسوق تراثية 100% بنكهة جدة القديمة وبأسعار شعبية ممتاز.",
    parkingAr: "مواقف باب مكة والبلد العامة",
    rating: 4.9,
    viewsCount: 32900,
    trending: true,
    mapsUrl: "https://www.google.com/maps/search/?api=1&query=Souq+Al+Alawi+Balad+Jeddah",
    image: "https://images.unsplash.com/photo-1578895210405-907db48a7111?auto=format&fit=crop&w=800&q=80",
  }),
  // ==================== إضافات المطاعم المتميزة في جدة ====================
  P({
    id: "r7",
    nameAr: "مطعم سكشن بي (Section-B Burger - الروضة)",
    nameEn: "Section-B Burger (Al Rawdah)",
    kind: "food",
    categoryAr: "مطاعم",
    subCategoryAr: "برجر واغيو فاخر",
    subCategoryEn: "Gourmet Burgers",
    districtId: "rawdah",
    moods: ["food", "friends"],
    pricePerPerson: 65,
    durationMin: 45,
    indoor: true,
    groups: ["friends", "solo", "duo", "coworkers"],
    kidsFriendly: true,
    reservation: false,
    verified: true,
    accessible: true,
    opensAt: 12,
    closesAt: 26,
    descAr: "أشهر مطاعم البرجر المحلي بجدة، يقدّم لحم الواغيو المقرمش مع البطاطس المبتكرة وصوصات سكشن الشهيرة.",
    descEn: "Jeddah's iconic gourmet burger place serving premium Wagyu beef patties and hand-cut fries.",
    whyAr: "أفضل تجربة برجر واغيو محلي بجدة بجودة عالية وسرعة خدمة.",
    parkingAr: "مواقف المجمع الخارجية",
    rating: 4.8,
    viewsCount: 29400,
    trending: true,
    mapsUrl: "https://www.google.com/maps/search/?api=1&query=Section+B+Burger+Rawdah+Jeddah",
    image: "https://images.unsplash.com/photo-1568901346375-23c9450c58cd?auto=format&fit=crop&w=800&q=80",
  }),
  P({
    id: "r8",
    nameAr: "مطعم نصرت ستيك هاوس (Nusr-Et Steakhouse - طريق الملك)",
    nameEn: "Nusr-Et Steakhouse (King Road)",
    kind: "food",
    categoryAr: "مطاعم",
    subCategoryAr: "ستيك فاخر وعروض شيف",
    subCategoryEn: "Luxury Steakhouse",
    districtId: "north",
    moods: ["food", "calm"],
    pricePerPerson: 350,
    durationMin: 90,
    indoor: true,
    groups: ["couple", "friends", "coworkers"],
    kidsFriendly: false,
    reservation: true,
    verified: true,
    accessible: true,
    opensAt: 13,
    closesAt: 25,
    descAr: "التجربة الفاخرة العالمية للحوم الستيك المغطاة بالذهب والتقطيع الاستعراضي أمام الطاولة برعاية الشيف نصرت.",
    descEn: "World-famous luxury steakhouse experience featuring gold leaf steaks and interactive table shows.",
    whyAr: "تجربة فخمة ومناسبة للمناسبات الخاصة والاحتفالات الفاخرة.",
    parkingAr: "خدمة الفاليه ومواقف خاصة",
    rating: 4.7,
    viewsCount: 19800,
    trending: true,
    mapsUrl: "https://www.google.com/maps/search/?api=1&query=Nusr+Et+Steakhouse+Jeddah",
    image: "https://images.unsplash.com/photo-1544025162-d76694265947?auto=format&fit=crop&w=800&q=80",
  }),

  // ==================== إضافات الكافيهات الرائجة في جدة ====================
  P({
    id: "c5",
    nameAr: "كافيه ومحمصة شغف القهوة (Shaghaf Coffee Roastery - الزهراء)",
    nameEn: "Shaghaf Coffee Roastery (Al Zahra)",
    kind: "cafe",
    categoryAr: "كافيهات",
    subCategoryAr: "قهوة مختصة وماتشا",
    subCategoryEn: "Specialty Coffee & Matcha",
    districtId: "zahra",
    moods: ["coffee", "calm"],
    pricePerPerson: 32,
    durationMin: 60,
    indoor: true,
    groups: ["solo", "friends", "couple", "duo"],
    kidsFriendly: true,
    reservation: false,
    verified: true,
    accessible: true,
    opensAt: 7,
    closesAt: 25,
    descAr: "كافيه هادئ ومتميز بمشروبات الماتشا اليابانية الأصلية والقهوة المختصة المحموصة محلياً وديكورات مريحة.",
    descEn: "Tranquil specialty coffee shop famous for authentic Japanese Matcha drinks & artisanal roasts.",
    whyAr: "جلسات رايقة ومشروبات ماتشا وقهوة مختصة بروقان عالي.",
    parkingAr: "مواقف أمام الكافيه",
    rating: 4.9,
    viewsCount: 22100,
    trending: true,
    mapsUrl: "https://www.google.com/maps/search/?api=1&query=Shaghaf+Coffee+Zahra+Jeddah",
    image: "https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?auto=format&fit=crop&w=800&q=80",
  }),
  P({
    id: "c6",
    nameAr: "كافيه 95 سيلزيوس (95 Celsius Coffee - الشاطئ)",
    nameEn: "95 Celsius Coffee (Ash Shati)",
    kind: "cafe",
    categoryAr: "كافيهات",
    subCategoryAr: "جلسات واجهة وبحر",
    subCategoryEn: "Sea View Specialty Coffee",
    districtId: "corniche",
    moods: ["coffee", "sea"],
    pricePerPerson: 36,
    ...
    opensAt: 6,
    closesAt: 26,
    descAr: "إطلالات مباشرة على واجهة جدة البحرية مع قائمة غنية بالحلى مبتكر والقهوة الباردة والساخنة.",
    descEn: "Stunning waterfront specialty coffee spot with sweeping views of the Red Sea.",
    whyAr: "إطلالة بحرية ساحرة وأجواء روقان ممتازة مع الغروب.",
    parkingAr: "مواقف الواجهة البحرية العامة",
    rating: 4.8,
    viewsCount: 25300,
    trending: true,
    mapsUrl: "https://www.google.com/maps/search/?api=1&query=95+Celsius+Coffee+Jeddah",
    image: "https://images.unsplash.com/photo-1501339847302-ac426a4a7cbb?auto=format&fit=crop&w=800&q=80",
  }),

  // ==================== إضافات المولات والتسوق الكبرى في جدة ====================
  P({
    id: "sh6",
    nameAr: "مول العرب (Mall of Arabia - حي النزهة)",
    nameEn: "Mall of Arabia (Al Nuzhah District)",
    kind: "shopping",
    categoryAr: "تسوق ومولات",
    subCategoryAr: "مول عائلي ضخم وسينما",
    subCategoryEn: "Mega Shopping Mall & Entertainment",
    districtId: "airport",
    moods: ["shopping", "games"],
    pricePerPerson: 40,
    durationMin: 180,
    ...
    opensAt: 10,
    closesAt: 24,
    descAr: "من أكبر وأشهر مولات جدة العائلية، يضم مدينة كيدزانيا للأطفال، مجمع سينما موفي، ومئات الماركات العالمية والمطاعم.",
    descEn: "One of Jeddah's largest mega-malls featuring KidZania, Muvi Cinemas, and hundreds of global brands.",
    whyAr: "وجهة تسوق وترفيه متكاملة لكافة أفراد العائلة تحت سقف واحد.",
    parkingAr: "مواقف مول العرب الضخمة وسريعة الحركة",
    rating: 4.9,
    viewsCount: 41200,
    trending: true,
    mapsUrl: "https://www.google.com/maps/search/?api=1&query=Mall+of+Arabia+Jeddah",
  ...
  P({
    id: "sh7",
    nameAr: "الأندلس مول (Al Andalus Mall - حي الفيحاء)",
    nameEn: "Al Andalus Mall (Al Fayhaa District)",
    kind: "shopping",
    categoryAr: "تسوق ومولات",
    subCategoryAr: "مول تسوق ومطاعم متنوعة",
    subCategoryEn: "Shopping Mall & Dining Hub",
    districtId: "central",
    moods: ["shopping", "food"],
    pricePerPerson: 30,
    durationMin: 150,
    indoor: true,
    groups: ["family", "friends", "kids", "duo"],
    kidsFriendly: true,
    reservation: false,
    verified: true,
    accessible: true,
    opensAt: 10,
    closesAt: 24,
    descAr: "مركز تسوق عائلي متميز يضم منطقة مطاعم واسعة، صالة ألعاب وسينما، ومنافذ ماركات الملابس العصرية وبأسعار مناسبة.",
    descEn: "Popular family mall with an expansive food court, family entertainment zones, and top fashion outlets.",
    whyAr: "تسوق عائلي مريح ومطاعم متنوعة بوسط جدة.",
    parkingAr: "مواقف المول السفلية والخارجية",
    rating: 4.8,
    viewsCount: 36800,
    trending: true,
    mapsUrl: "https://www.google.com/maps/search/?api=1&query=Al+Andalus+Mall+Jeddah",
    image: "https://images.unsplash.com/photo-1567449303078-57ad995bd301?auto=format&fit=crop&w=800&q=80",
  }),
];
